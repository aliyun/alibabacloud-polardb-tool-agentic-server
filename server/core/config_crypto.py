...
class ConfigCrypto:
    ...
    def managed_digest(self, purpose: str, value: Any) -> str:
        ...
        # This keyed authenticator protects idempotency receipts; it is not
        # used to store or verify a password.
        managed_hmac_key = self._managed_hmac_key
        # codeql[py/weak-sensitive-data-hashing]
        return hmac.new(managed_hmac_key, canonical, hashlib.sha256).hexdigest()
