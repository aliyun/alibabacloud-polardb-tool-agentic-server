...
from server.models import AllocationMode, Base, InstanceTopology
from server.models.instance import Instance, InstanceStatus, ProvisioningStep
...
class TestInstanceStatusExtensions:
    def test_lifecycle_statuses_do_not_encode_allocation(self):
        assert AllocationMode.POOLED.value == "pooled"
