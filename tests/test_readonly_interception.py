...
class TestReadonlyEnforcement:
    ...
    async def test_readonly_user_branch_tool_delegates_permission_to_database(
        self, ro_client, ro_headers, setup_readonly
    ):
        """Branch tools intentionally rely on PolarDB SQL privileges."""
